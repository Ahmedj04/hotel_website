    ...
    return (
        <section className="relative md:h-screen">
            ...
            <div className=" relative text-center pt-32 pb-44 md:top-72 lg:top-5 xl:top-10">
               ...
               <>  <h1 className="text-white font-extralight tracking-widest lg:text-lg lg:font-normal 2xl:font-medium">{lang?.welcomeTo} {allHotelDetails?.star_rating} <i><StarIcon className="text-2xl" sx={{ color: 'orange' }} /> </i> {lang?.hotel}</h1></>}
